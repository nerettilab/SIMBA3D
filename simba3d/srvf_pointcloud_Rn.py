# -*- coding: utf-8 -*-
"""
Square Root Velocity Function tools for landmark based point clouds
...
def find_best_ortho(curve1,curve2):
    '''
    Optimally orthogonally transformation the second curve to the first curve
    '''
    [n,T]=np.shape(curve1)
    transpose=False;
    if T<n:
...
def standarize_curve(curve):
    '''
    center the curve to the origin and scale it
    '''
