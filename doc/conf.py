...
latex_documents = [
  ('index', 'simba3d.tex', u'simba3d Documentation',
   u'Author', 'manual'),
]
...
man_pages = [
    ('index', 'simba3d', u'simba3d Documentation',
     [u'Author'], 1)
]
...
texinfo_documents = [
  ('index', 'simba3d', u'simba3d Documentation',
   u'Author', 'simba3d', 'One line description of project.',
   'Miscellaneous'),
]
