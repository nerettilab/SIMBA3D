      ...
      tasks.append(
          {
              ...
              'file_names'  :
                  ...
                  'output_filename':"add_a_tag_name_here_"+UUID+'_'+str(res[ii])+'.npz' # manually assign name to output file
                  },
              ...
              'parameters'    :
                  ...
                  'term_weights'   :  
                      ...
                      'uniform_spacing'  : 0.5, # scaled first order penalty
                      'smoothing'        : 1.0, # scaled second order penalty
                      'population_prior' : 0.1,    # weight for the population matrix prior
