...
taskfilepath="simple_but_long_tasklist.txt"
	...
	tasks.append(
		{
		    ...
		    # options
		    "option_maxitr"    : 100000, # set maximum number of iterations
		    "option_display"   : True, # display function values at each iteration
		    "option_store"     : False, # store iterative curves
		    "option_method"    : "BFGS",# Broyden, Fletcher, Goldfarb, and Shanno (quasi-Newton, only first derivatives are used)
		    #"option_method"    :"Nelder-Mead",# robust but slow numerical approach
		    #"option_method"    :"CG",# nonlinear conjugate gradient algorithm by Polak and Ribiere (only first derivatives are used)
		    #"option_method"    :"Newton-CG",# (truncated Newton method)
		    "option_gradient tolerance"    : 1e-5,
	    }    
	)
	iii+=1
